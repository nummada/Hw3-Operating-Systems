...
COMMON_IGNORE_FLAGS="
	SPLIT_STRING,SSCANF_TO_KSTRTO,NEW_TYPEDEFS,VOLATILE,INLINE,USE_FUNC,AVOID_EXTERNS,CONST_STRUCT,SYMBOLIC_PERMS,FUNCTION_ARGUMENTS,SPDX_LICENSE_TAG"
...
check_source()
{
	...
	touch $(dirname $check_patch)/const_structs.checkpatch &> /dev/null
